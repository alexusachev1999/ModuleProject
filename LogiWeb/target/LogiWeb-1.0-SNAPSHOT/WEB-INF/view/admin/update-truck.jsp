...
<div class="main">
    <div class="col-md-6 col-sm-12">
        <form:form action="updateTruck" modelAttribute="truck" cssClass="login-form">
            ...
            <button type="submit" name="submit" class="btn btn-black">Обновить фуру</button>
        </form:form>
    </div>
</div>
</body>
