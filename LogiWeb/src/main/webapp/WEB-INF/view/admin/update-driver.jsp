...
<div class="main">
    <div class="col-md-6 col-sm-12">
        <form:form action="updateDriver" modelAttribute="driver" cssClass="login-form">
            ...
            <input type="submit" class="btn btn-black" value="Обновить водителя">
        </form:form>
    </div>
</div>
</body>
