...
<div class="main">
    <div class="col-md-6 col-sm-12">
        <form:form action="saveNewWorkType" modelAttribute="driver" cssClass="login-form">
            ...
            <div class="form-group">
                <label class="col-form-label-lg">Изменить тип работ</label>
            ...
            <input type="submit" class="btn btn-black" value="Изменить тип работ">
        </form:form>
    </div>
</div>
</body>
